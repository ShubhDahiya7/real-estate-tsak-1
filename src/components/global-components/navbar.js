                  ...
                  <li>
                    <p>
                      <img
                        ...
                        alt="img"
                      />{" "}
                      pespro2727@gmail.com
                    </p>
                  </li>
                </ul>
              </div>
              <div className="col-lg-4">
                <ul className="topbar-right text-center">
                  {localStorage.getItem('sd-user') ?<li onClick={()=>{
                    localStorage.setItem('sd-user', "");
                    window.location = "/"
                  }} style={{cursor: 'pointer'}}>
                    <p>{localStorage.getItem('sd-user')}</p>
                  </li>: (<><li>
          ...
          <div className="container nav-container">
            ...
            <div className="logo">
              <Link to="/">
                ...
                <h2 style={{color: '#ffffffcc', margin: 0, paddingBottom: 0}}>SD States</h2>
              </Link>
            </div>
